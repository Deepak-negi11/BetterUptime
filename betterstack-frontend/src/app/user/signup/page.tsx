                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-[#13141F] border border-[#1E293B] rounded-xl p-8">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <a href={getOAuthUrl('google')} className="flex items-center justify-center gap-2 px-4 py-3 bg-[#0C0C14] border border-[#1E293B] rounded-lg text-white/70 hover:text-white hover:border-[#5850ec]/50 transition-all">
                            ...
                            <a href={getOAuthUrl('github')} className="flex items-center justify-center gap-2 px-4 py-3 bg-[#0C0C14] border border-[#1E293B] rounded-lg text-white/70 hover:text-white hover:border-[#5850ec]/50 transition-all">
